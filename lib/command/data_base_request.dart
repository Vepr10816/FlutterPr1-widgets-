...
abstract class DataBaseRequest{
  ...
  static const List<String> tableList = [tableRole, tableClient,tableUsers,tableSizeFurniture,tableCharacteristics,tableMaterial,tableColor,tableFurniture,tableFurnitureImage,tableOrder];

  static const List<String> tableCreateList = [_createTableRole, _createTableClient,_createTableUsers,_createTableSizeFurniture,_createTableCharacteristics,_createTableMaterial,_createTableColor,_createTableFurniture,_createTableFurnitureImage,_createTableOrder];
  ...
  static const String _createTableClient =
      ...
      'CREATE TABLE "$tableClient" ("id"	INTEGER NOT NULL, "lastName"	TEXT NOT NULL, "firstName"	TEXT NOT NULL, "middleName"	TEXT, "email"	TEXT NOT NULL UNIQUE, PRIMARY KEY("id" AUTOINCREMENT));';

  static const String _createTableUsers =

      'CREATE TABLE "$tableUsers" ("id"	INTEGER NOT NULL,"login"	TEXT NOT NULL UNIQUE,"password"	TEXT NOT NULL,"id_role"	INTEGER NOT NULL,"id_client"	INTEGER NOT NULL,PRIMARY KEY("id" AUTOINCREMENT),FOREIGN KEY("id_client") REFERENCES "Client"("id"),FOREIGN KEY("id_role") REFERENCES "Role"("id"));';
